...
const Hero = () => {
    return (
        ...
        <div className='relative z-10 md:flex gap-5 md:justify-between md:max-w-7xl m-auto md:py-2 py-20 md:px-20 px-5'>
            <div className='flex relative flex-col gap-5 z-10 '>

                    <div className='pr-20 flex absolute z-0 top-0 right-[-12%] lg:hidden'>
                        <Lottie
                            loop={true}
                            autoPlay={true}
                            animationData={json}
                ...
                <div className='flex flex-col leading-tight z-10  '>
                    ...
                    <div className='flex items-end gap-1'>
                        ...
                        <span className='pl-3 h-[12px] mb-[10px]  rounded-full bg-[#fc3792]'></span>
                    </div>
                </div>
                ...
                <div className='flex mt-5 z-10 '>
                    <div className='relative cursor-pointer transition duration-300 ease-in-out z-10 hover:shadow-lg hover:shadow-[#ff395161] hover:bg-opacity-38 hover:translate-y-[-6px] translate-z-[0.01px] overflow-hidden text-white bg-[#fc3792] py-7 px-14 flex items-center rounded-full font-bold'>
...
<div>
    ...
    <div className='flex flex-col'>
        <span>WE ARE</span>
        <div className='flex items-end gap-1'>
            <h1 className=' font-extrabold text-[64px] text-[#14142b]'>ADS WORK  </h1>
            <span className='pl-3 h-[12px] pb-2  rounded-full bg-[#fc3792]'></span>
        </div>
    </div>
